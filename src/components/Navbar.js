...
export default function Navbar() {
  const [navBarStateClosed, setNavBarStateClosed] = React.useState(false);
  ...
  return (
    <nav className={navBarStateClosed ? "" : "mobile-open"}>
      ...
      <ul className={navBarStateClosed ? "ul_none" : "ul_visible"}>
        <li>
          <Link to="/">Home</Link>
        </li>
        {currentUser && (
        ...
        {currentUser && (
          <div className="nav-profile-container">
            <div
              className="user-img-name-container"
            ...
            {profilemenu && (
              ...
              >
                <ul className="profile-sub-menu">
                  ...
                  <li>
                    <a href={`/user/${currentUser.idusers}#delete-account`}>
                      Delete account
                    </a>
                  </li>
                </ul>
